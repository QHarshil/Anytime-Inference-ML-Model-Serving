...
def compute_pareto_frontier(
    ...
    points = list(zip(df[latency_col], df[accuracy_col], strict=True))
    mask = []
...
def dominance_ratio(
    ...
    method_points = list(zip(method_df[latency_col], method_df[accuracy_col], strict=True))
    baseline_points = list(zip(baseline_df[latency_col], baseline_df[accuracy_col], strict=True))
